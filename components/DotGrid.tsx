...
const DotGrid: React.FC<DotGridProps> = ({
 ...
 useEffect(() => {
  ...
  let ro: globalThis.ResizeObserver | undefined;
  const canUseRO = typeof window !== 'undefined' && 'ResizeObserver' in window;
  ...
  return () => {
    ro?.disconnect();
    if (!canUseRO) window.removeEventListener('resize', buildGrid);
  };
}, [buildGrid]);
